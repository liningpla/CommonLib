...
public class PriorityExecutor extends ThreadPoolExecutor {
    ...
    private static final int DEV_CUP_NUM = Runtime.getRuntime().availableProcessors();
    private static final int CORE_POOL_SIZE = DEV_CUP_NUM + 1;//线程池维护线程的最少数量
    private static final int MAXIMUM_POOL_SIZE = DEV_CUP_NUM*2 + 1;//线程池维护线程的最大数量
