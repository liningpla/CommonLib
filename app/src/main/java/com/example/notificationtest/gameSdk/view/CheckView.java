package com.example.notificationtest.gameSdk.view;
...
import com.example.notificationtest.activity.LeUI;
...
public class CheckView extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSize = ta.getDimensionPixelSize(R.styleable.CheckView_ev_size, LeUI.getDensityDimen(getContext(), 18));
        mType = ta.getInt(R.styleable.CheckView_ev_type, TYPE_CIRCLE);

        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.CheckView_ev_strokeWidth,  LeUI.getDensityDimen(getContext(), 2));
        ...
        mCheckDrawable = ResourcesCompat.getDrawable(context.getResources(),
                R.drawable.ic_pay_check_white_18dp, context.getTheme());
