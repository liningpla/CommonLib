...
public class WaterDropDrawable extends RefreshDrawable implements Runnable {
    ...
    private static final float CIRCLE_COUNT = WaterDropDrawable.ProgressStates.values().length;
    ...
    private WaterDropDrawable.ProgressStates mCurrentState;
    ...
    private void updateLevel(int level) {
        ...
        int endColor = mColorSchemeColors[(stateForLevel + 1) % WaterDropDrawable.ProgressStates.values().length];
